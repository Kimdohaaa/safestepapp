...
// 환자의 위치 등록 파일 //
class AdditionLocation extends StatefulWidget {
  const AdditionLocation({super.key});

  @override
  State<StatefulWidget> createState() {
    return _AdditionLocationState();
  }
}

class _AdditionLocationState extends State<AdditionLocation> {
  Dio dio = Dio();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: const SafeArea(
        child: NaverMapApp(), // 지도 위젯을 SafeArea 안에 넣음
      ),
